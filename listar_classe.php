...
include_once("menu_admin.php");
	  ...
	  //Consultas SQL 
include "sql/admin/listar/sql_listar_classe.php";
								...
								<tr>
									...
									<td>
										...
										<td>
											...
											>Editar</button>
											<!-- Não permitir apagar caso a classe esteja atrelada a alunos - analisar a possibilidade-->
			...
			<div class="modal fade" id="Modal" tabindex="-1" role="dialog" aria-labelledby="ModalLabel">
				<div class="modal-dialog" role="document">
					<div class="modal-content">
						...
						<!--Não vai poder ALT o número da classe, pois precisará do Nº do ID e não tem como ALT o Número e ID ao mesmo tempo-->
								<div class="form-group">
								...
								<div class="form-group">
									<label for="recipient-igreja" class="control-label">Igreja:</label>
									<input name="igreja" type="text" readonly="readonly" class="form-control" id="recipient-igreja">
								</div>
