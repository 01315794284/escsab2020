...
$resultado_check=mysqli_query($conn, "SELECT * FROM apontamento where classe = $numerologin ORDER BY id_apontamento DESC");
$linhas_check=mysqli_num_rows($resultado_check);
