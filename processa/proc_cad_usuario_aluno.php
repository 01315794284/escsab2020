...
$result_usuario = "INSERT INTO `usuarios` (`id_usuarios`, `nome`, `login`, `email`, `senha`, 
`endereco`, `datanascimento`, `databatismo`, `telefone1`, `telefone2`, `niveis_acesso_id`,
`classe`, `licao`, `adventista`, `igreja`) VALUES (NULL, '$nome', '$login', '$email', '$senha', '$endereco', '$datanascimento',
'$databatismo', '$telefone1', '$telefone2', '$niveis_acesso_id', '$classes', '$licao', '$adventista', '$igreja')";
