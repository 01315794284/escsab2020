...
$igreja		 		= filter_input(INPUT_POST, 'igreja', FILTER_SANITIZE_STRING);// $_POST["niveis_acesso_id"];//


//echo "Nome: $nome <br>";
//echo "E-mail: $email <br>";

$result_usuario = " INSERT INTO `iasdfonseca`.`visitantes` (`id_visitantes`, `nome`,`observacao` , `email`, `endereco`, `datanascimento`, `telefone1`, `estudobiblico`, `oracao`, `visita`, `numerodaclasse`, `datacadastro` , `igreja`) VALUES (NULL, '$nome', '$observacao', '$email', '$endereco', '$datanascimento', '$telefone1', '$estudobiblico', '$oracao', '$visita', '$numerodaclasse', '$datacadastro', '$igreja')"; 
