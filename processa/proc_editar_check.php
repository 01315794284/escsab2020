...
$_SESSION['qtdalunospresente_editar'] = $contador;
$_SESSION['dataapontamento_editar'] = $dataapontamento2;
...
$result_apontamento = " UPDATE checkbox SET `dataapontamento`='$dataapontamento', `classe`='$classe',  `resultado`='$resultado'   WHERE id_check = '$id_check'";
