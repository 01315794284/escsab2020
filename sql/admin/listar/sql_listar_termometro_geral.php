...
$sqlestudo = mysqli_query($conn , "SELECT *, sum(estudo) estudo_sabado FROM apontamento WHERE igreja = $igreja AND  dataapontamento=$dataapontamento");
...
$sqlencontro = mysqli_query($conn , "SELECT *, sum(encontro) encontro_sabado FROM apontamento WHERE igreja = $igreja AND  dataapontamento=$dataapontamento");
...
$sqlestudosbiblicos = mysqli_query($conn , "SELECT *, sum(estudosbiblicos) estudosbiblicos_sabado FROM apontamento WHERE igreja = $igreja AND  dataapontamento=$dataapontamento");
...
//-----------------------------------------Acao Soliária------------------------------------------------
//VRF o valor de acao
$sqlacao = mysqli_query($conn , "SELECT *, sum(acao) acao_sabado FROM apontamento WHERE igreja = $igreja AND  dataapontamento=$dataapontamento");
...
$sqlpresenca = mysqli_query($conn , "SELECT *, sum(presenca) presenca_sabado FROM apontamento WHERE igreja = $igreja AND  dataapontamento=$dataapontamento");
...
//-----------------------------------------Contatos------------------------------------------------
//VRF o valor de presenca
$sqlcontato = mysqli_query($conn , "SELECT *, sum(contato) contato_sabado FROM apontamento WHERE igreja = $igreja AND  dataapontamento=$dataapontamento");
...
$sqlqtd_alunos = mysqli_query($conn , "SELECT *, count(niveis_acesso_id) qtd_alunos FROM usuarios WHERE igreja = $igreja AND  niveis_acesso_id <=4");
...
$sqloferta = mysqli_query($conn , "SELECT *, sum(oferta) oferta_sabado FROM apontamento WHERE igreja = $igreja AND  dataapontamento=$dataapontamento");
...
$sqlalvodeoferta = mysqli_query($conn , "SELECT *, sum(alvodeoferta) valor_oferta FROM classes WHERE igreja = $igreja");
